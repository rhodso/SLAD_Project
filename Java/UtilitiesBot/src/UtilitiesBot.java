...
public class UtilitiesBot {
    ...
    String getToken() {
        try {
            ...
            if(!f.exists()){
                ...
                //If it doesn't, then create a file and tell the user that they should put the token here
    ...
    //Set the prefix. Returns true/false depending on if the operation was successful
    boolean setPrefix(String newPrefix) {
        BufferedWriter bw = null;
        try {
            //Try and find the file, if it doesn't exist then just create, if it does, delete first
